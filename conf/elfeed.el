...
(use-package! elfeed
  ...
  (setq
        ...
        elfeed-db-directory "~/.shared/elfeed/db/"
        elfeed-enclosure-default-dir "~/.shared/elfeed/enclosures/"
 ...
 (push (lambda (buf) (string-match-p "^\\*elfeed" (buffer-name buf)))
  ...
  ;; (add-hook! 'elfeed-search-update-hook #'(solaire-mode hide-mode-line-mode))
